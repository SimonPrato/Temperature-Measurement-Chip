...
C {ipin.sym} -400 -300 0 0 {name=p1 lab=VDD}
...
C {code_shown.sym} 340 -560 0 0 {name=ngspice1 only_toplevel=false 
value="
**.temp 120
**.param mc_ok=1
**.control
...
C {code_shown.sym} 380 0 0 0 {name=ngspice2 only_toplevel=false 
value="
**.temp 130
**.param l=40u
**.control
